class DeliveryAddressMultiples
  ...
  attr_accessor :item, :user_id, :postal_code, :address_prefecture_id, :address_municipality, :address_block, :address_building, :telephone_number, :purchase_record
  ...
  def save
    ...
    delivery_addresses =DeliveryAddress.create(postal_code: postal_code, address_prefecture_id: address_prefecture_id, address_municipality: address_municipality, address_block: address_block, address_building: address_building, telephone_number: telephone_number)
  end
end